...
In this case study we look at the correlation between CO2 emissions and annual average temperatures in the US. We also evaluate the association between the two using a linear regression. We discuss the relationship between correlation and linear regression and how we interpret the findings.
...
[directlabels](https://github.com/tdhock/directlabels){target="_blank"} | to add labels to plots easily
